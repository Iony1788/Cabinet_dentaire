 ...
 */
@Entity
public class NiveauRecuperationRoute {
    @Id
    ...
    public NiveauRecuperationRoute() {
    }

    public NiveauRecuperationRoute(Long id, int niveau, int niveau_min, int niveau_max, int niveau_apres) {
        this.id = id;
        this.niveau = niveau;
    ...
    public NiveauRecuperationRoute(int niveau, int niveau_min, int niveau_max, int niveau_apres) {
        this.niveau = niveau;
        this.niveau_min = niveau_min;
        this.niveau_max = niveau_max;
        this.niveau_apres = niveau_apres;
